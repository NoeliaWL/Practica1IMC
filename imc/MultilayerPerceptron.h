...
public:
	...
	void runOnlineBackPropagation(util::Dataset * trainDataset, util::Dataset * testDataset, int maxiter, double *errorTrain, double *errorTest, std::string name);
